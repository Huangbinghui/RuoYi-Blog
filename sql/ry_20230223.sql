...
-- No native definition for element: sched_name (index)
...
-- rm_blog: table
CREATE TABLE `rm_blog`
(
    `info_id` bigint NOT NULL COMMENT '博客内容Id',
    `content` text COLLATE utf8mb4_general_ci COMMENT '博客内容',
    PRIMARY KEY (`info_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='博客内容表';

-- rm_blog_info: table
CREATE TABLE `rm_blog_info`
(
    `id`            bigint    NOT NULL COMMENT '主键',
    `is_deleted`    tinyint(1)                              DEFAULT NULL COMMENT '是否已删除',
    `title`         varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标题',
    `blog_type`     bigint                                  DEFAULT NULL COMMENT '博客类型',
    `is_top`        tinyint(1)                              DEFAULT NULL COMMENT '是否置顶',
    `author_id`     bigint                                  DEFAULT NULL COMMENT '作者id',
    `original_link` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '原始链接',
    `is_original`   tinyint(1)                              DEFAULT NULL COMMENT '是否原创',
    `is_private`    tinyint(1)                              DEFAULT NULL COMMENT '是否私密',
    `version`       varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '版本号',
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='博客元信息表';
...
(
    ...
    `content`      varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论内容',
    `blog_id`      bigint                                  DEFAULT NULL COMMENT '博客Id',
    `comment_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论类型id',
    `is_top`       tinyint(1)                              DEFAULT NULL COMMENT '是否置顶',
    `is_deleted`   tinyint(1)                              DEFAULT NULL COMMENT '是否已删除',
    `create_by`    varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人',
    `create_time`  timestamp NULL                          DEFAULT NULL COMMENT '创建时间',
...
-- rr_user_like: table
CREATE TABLE `rr_user_like`
(
    `target_id` bigint NOT NULL COMMENT '目标ID',
    `user_id`   bigint NOT NULL COMMENT '用户ID',
    `is_like`   tinyint(1)                              DEFAULT NULL COMMENT '是否点赞',
    `like_type` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '点赞类型',
    PRIMARY KEY (`target_id`, `user_id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='用户点赞表';
